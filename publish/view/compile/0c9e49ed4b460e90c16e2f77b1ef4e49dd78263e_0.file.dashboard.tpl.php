...
function content_5cb6908d16a910_81364276 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="es">
    <head>
...
!</strong></p>
                        ...
                        <aside class="col-right sidebar col-sm-3 col-xs-12 wow bounceInUp animated animated" style="visibility: visible;">
                            <button type="button" class="button " style="align-items: flex-end" title="create" name="send" id="send"><span>Crear Anuncio</span></button>
                            <button type="button" class="button " style="align-items: flex-end" title="Ingresar" name="send" id="send"><span>Crear Subasta</span></button>

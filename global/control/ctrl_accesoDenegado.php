...
switch ($action) {
    ...
    default:
        ...
        $smarty->assign('user_name', $_SESSION["nombre"]);
        $smarty->assign('body_message', 'Su usuario no posee las credenciales necesarias para visualizar la página que solícito, si desea más información por favor contacte con el administrador del sistema.');
        ...
        $smarty->display('accesoDenegado.tpl');

...
<html lang="es">
    ...
    <body>
        ...
        <script type="text/javascript" src='http://maps.google.com/maps/api/js?key={$googleMapsKey}'></script>
        <script src="../resources/app-assets/vendors/js/jquery-locationpicker/dist/locationpicker.jquery.js"></script>
        <script src="../resources/app-assets/vendors/js/croppie.js"></script>


        <script src="../global/js/global.js?{$versionJs}" type="text/javascript"></script>
        <script src="js/complete.js?{$versionJs}" type="text/javascript"></script>
